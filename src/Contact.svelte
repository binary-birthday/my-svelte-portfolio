...
<div class="main" id="main" scrollPos={scrollPos} elementPos={elementPos} >
  ...
  <div class="form-container">
    ...
    <form action="https://formspree.io/wsmartin23@gmail.com" method="POST">      
      ...
      <input transition:scale="{{duration: 1000, delay: 250, opacity: 0, start: .75, easing:elasticOut}}" name="name" type="text" class="form-input" placeholder="Name" />   
      <input transition:scale="{{duration: 1000, delay: 300, opacity: 0, start: .75, easing:elasticOut}}" name="email" type="text" class="form-input" placeholder="Email" />
      <textarea transition:scale="{{duration: 1000, delay: 450, opacity: 0, start: .75, easing:elasticOut}}" name="text" class="form-input" placeholder="Your Message here..."></textarea>
      <input transition:scale="{{duration: 1000, delay: 500, opacity: 0, start: .75, easing:elasticOut}}" type="submit" value="SUBMIT"/>
    </form> 
    {/if}
  </div>
</div>
