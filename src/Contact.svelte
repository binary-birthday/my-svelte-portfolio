...
<div class="main">
  ...
  <div class="form-container">
    ...
    <form action="https://formspree.io/wsmartin23@gmail.com" method="POST">      
      ...
      <input in:scale="{{duration: 1500, delay: 550, opacity: 0, start: .75, easing:elasticOut}}" out:fade="{{delay: 0, duration: 200}}" name="name" type="text" class="form-input" placeholder="Name" />   
      <input in:scale="{{duration: 1500, delay: 600, opacity: 0, start: .75, easing:elasticOut}}" out:fade="{{delay: 0, duration: 200}}" name="email" type="text" class="form-input" placeholder="Email" />
      <textarea in:scale="{{duration: 1500, delay: 650, opacity: 0, start: .75, easing:elasticOut}}" out:fade="{{delay: 0, duration: 200}}" name="text" class="form-input" placeholder="Your Message here..."></textarea>
      <input in:scale="{{duration: 1500, delay: 700, opacity: 0, start: .75, easing:elasticOut}}" out:fade="{{delay: 0, duration: 200}}" type="submit" value="SUBMIT"/>
    </form> 
    {/if}
  </div>
</div>
