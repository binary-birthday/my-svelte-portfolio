...
<div bind:offsetHeight={height} class="landing-container">
  {#if visible}
    <div class="left" out:fade={{ delay: 0, duration: 4000 }}>
      ...
      <span in:typewriter={{ delay: 2350, speed: 50 }} class="strong"
        >Wade Martin.</span
      ><br />
      <span in:typewriter={{ delay: 3900, speed: 50 }}>I build Web Apps.</span
      ><br />
      <span in:typewriter={{ delay: 5700, speed: 50 }}
...
<style>
  ...
  @media only screen and (max-width: 700px) {
    ...
    .strong {
      text-shadow: 0.5px 0.5px #00000022;
    }
  }
</style>
