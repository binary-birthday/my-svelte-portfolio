    ...
    <div class="card-container">
      <div class="card">
        <div>
          ...
          <p> 
            Wade is a full stack web developer and 2019 Coder Academy boot camp alumnus. Wade completed the 6 month fast track Diploma program at Coder Academy in Ausgust 2019 including a four week internship with Flex Dapps. Coder Academy's program is focussed on job ready, in demand web development skills including React, NodeJS, HTML, CSS, Javascript, Express, MongoDB, Ruby and Ruby on Rails. Among his acheivements in this program Wade are two full stack web development group projects. The first a marketplace application built using Ruby on Rails deployed with Heroku (Check out the Repo <a href="https://github.com/Wade-Martin/rails_marketplace_app">Here</a>) The second a project partnered with an external business stakeholder built using the MERN stack delpoyed with NOW.SH and Netlify (Check out the Front End Repo <a href="https://github.com/Wade-Martin/MERN-App-Front-End">Here</a>, and the Back End Repo <a href="https://github.com/timwaldron/MERN-App-Back-End">Here</a>). During his time with Flex Dapps Wade took on a project to rebuild the Web3 Australia Organistion website using Svelte and deplyed on Netlify. (Check out the site <a href="https://web3-build.netlify.com/">here</a>)
          </p>
        </div>
        
        <div class="icons">
          <a href="https://github.com/Wade-Martin"><i class="fab fa-github"></i></a>
          <a href="https://codepen.io/wade-martin"><i class="fab fa-codepen"></i></a>
          <a href="https://www.linkedin.com/in/wade-s-martin/"><i class="fab fa-linkedin"></i></a>
