    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path0, file$1, 48, 6, 807);
    			...
    			add_location(path1, file$1, 49, 0, 1148);
    			...
    			add_location(path2, file$1, 50, 0, 1450);
    			...
    			add_location(path3, file$1, 51, 0, 1754);
    			...
    			add_location(path4, file$1, 52, 0, 2064);
    			...
    			add_location(path5, file$1, 53, 0, 2237);
    			...
    			add_location(path6, file$1, 54, 0, 3251);
    			...
    			add_location(path7, file$1, 55, 0, 3795);
    			...
    			add_location(path8, file$1, 56, 0, 18427);
    			attr_dev(g0, "id", "ventricle-group");
    			add_location(g0, file$1, 47, 4, 776);
    			...
    			add_location(path9, file$1, 59, 0, 29136);
    			...
    			add_location(ellipse0, file$1, 60, 0, 29304);
    			...
    			add_location(path10, file$1, 61, 0, 29431);
    			...
    			add_location(path11, file$1, 62, 0, 30300);
    			...
    			add_location(path12, file$1, 63, 0, 30478);
    			...
    			add_location(path13, file$1, 64, 0, 34534);
    			...
    			add_location(path14, file$1, 65, 0, 35589);
    			...
    			add_location(path15, file$1, 66, 0, 35873);
    			...
    			add_location(path16, file$1, 67, 0, 36663);
    			...
    			add_location(path17, file$1, 68, 0, 40548);
    			...
    			add_location(path18, file$1, 69, 0, 40818);
    			...
    			add_location(path19, file$1, 70, 0, 41111);
    			...
    			add_location(path20, file$1, 71, 0, 42118);
    			...
    			add_location(path21, file$1, 72, 0, 43170);
    			...
    			add_location(ellipse1, file$1, 73, 0, 45849);
    			...
    			add_location(path22, file$1, 74, 0, 45927);
    			attr_dev(g1, "id", "atrium-group");
    			add_location(g1, file$1, 58, 0, 29114);
    			attr_dev(g2, "id", "anatomicalHeart");
    			attr_dev(g2, "class", "svelte-m9rthk");
    			add_location(g2, file$1, 46, 2, 747);
    			attr_dev(svg, "width", "100%");
    			attr_dev(svg, "height", "100%");
    			attr_dev(svg, "viewBox", "0 0 300 500");
    			attr_dev(svg, "fill", "none");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			add_location(svg, file$1, 45, 2, 641);
    			attr_dev(div0, "class", "pericardium svelte-m9rthk");
    			add_location(div0, file$1, 44, 2, 613);
    			attr_dev(div1, "class", "background svelte-m9rthk");
    			add_location(div1, file$1, 43, 0, 586);
    		},
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p0, "class", "greting1 svelte-7i2efo");
    			toggle_class(p0, "dn", ctx.dn1);
    			add_location(p0, file$2, 124, 4, 2284);
    			attr_dev(p1, "class", "greting2 svelte-7i2efo");
    			toggle_class(p1, "dn", ctx.dn2);
    			add_location(p1, file$2, 125, 3, 2348);
    			attr_dev(p2, "class", "greting3 svelte-7i2efo");
    			toggle_class(p2, "dn", ctx.dn3);
    			add_location(p2, file$2, 126, 3, 2421);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_if_block$1.name, type: "if", source: "(124:4) {#if visible}", ctx });
    	return block;
    }
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "right svelte-7i2efo");
    			add_location(div0, file$2, 122, 2, 2241);
    			attr_dev(div1, "class", "landing-container svelte-7i2efo");
    			add_location(div1, file$2, 121, 0, 2207);
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t12 = space();
    			div3 = element("div");
    			attr_dev(img, "class", "profile svelte-1adpln6");
    			attr_dev(img, "src", "images/profile.jpg");
    			attr_dev(img, "alt", "profile image");
    			add_location(img, file$3, 63, 6, 1137);
    			attr_dev(a0, "href", "https://github.com/Wade-Martin/rails_marketplace_app");
    			add_location(a0, file$3, 65, 433, 1650);
    			attr_dev(a1, "href", "https://github.com/Wade-Martin/MERN-App-Front-End");
    			add_location(a1, file$3, 65, 654, 1871);
    			attr_dev(a2, "href", "https://github.com/timwaldron/MERN-App-Back-End");
    			add_location(a2, file$3, 65, 741, 1958);
    			attr_dev(p, "class", "svelte-1adpln6");
    			add_location(p, file$3, 64, 6, 1212);
    			add_location(div0, file$3, 62, 4, 1125);
    			attr_dev(i0, "class", "fab fa-github svelte-1adpln6");
    			add_location(i0, file$3, 69, 47, 2136);
    			attr_dev(a3, "href", "https://github.com/Wade-Martin");
    			add_location(a3, file$3, 69, 6, 2095);
    			attr_dev(i1, "class", "fab fa-codepen svelte-1adpln6");
    			add_location(i1, file$3, 70, 47, 2217);
    			attr_dev(a4, "href", "https://codepen.io/wade-martin");
    			add_location(a4, file$3, 70, 6, 2176);
    			attr_dev(i2, "class", "fab fa-linkedin svelte-1adpln6");
    			add_location(i2, file$3, 71, 59, 2311);
    			attr_dev(a5, "href", "https://www.linkedin.com/in/wade-s-martin/");
    			add_location(a5, file$3, 71, 6, 2258);
    			attr_dev(i3, "class", "fab fa-twitter-square svelte-1adpln6");
    			add_location(i3, file$3, 72, 50, 2397);
    			attr_dev(a6, "href", "https://twitter.com/wine_and_Wade");
    			add_location(a6, file$3, 72, 6, 2353);
    			attr_dev(div1, "class", "icons svelte-1adpln6");
    			add_location(div1, file$3, 68, 4, 2069);
    			attr_dev(div2, "class", "card svelte-1adpln6");
    			add_location(div2, file$3, 61, 2, 1102);
    			attr_dev(div3, "class", "card svelte-1adpln6");
    			add_location(div3, file$3, 75, 2, 2461);
    			attr_dev(div4, "class", "about-container svelte-1adpln6");
    			add_location(div4, file$3, 60, 0, 1070);
    		},
