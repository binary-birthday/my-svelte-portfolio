    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path0, file$1, 44, 6, 716);
    			...
    			add_location(path1, file$1, 45, 0, 1057);
    			...
    			add_location(path2, file$1, 46, 0, 1359);
    			...
    			add_location(path3, file$1, 47, 0, 1663);
    			...
    			add_location(path4, file$1, 48, 0, 1973);
    			...
    			add_location(path5, file$1, 49, 0, 2146);
    			...
    			add_location(path6, file$1, 50, 0, 3160);
    			...
    			add_location(path7, file$1, 51, 0, 3704);
    			...
    			add_location(path8, file$1, 52, 0, 18336);
    			attr_dev(g0, "id", "ventricle-group");
    			add_location(g0, file$1, 43, 4, 685);
    			...
    			add_location(path9, file$1, 55, 0, 29045);
    			...
    			add_location(ellipse0, file$1, 56, 0, 29213);
    			...
    			add_location(path10, file$1, 57, 0, 29340);
    			...
    			add_location(path11, file$1, 58, 0, 30209);
    			...
    			add_location(path12, file$1, 59, 0, 30387);
    			...
    			add_location(path13, file$1, 60, 0, 34443);
    			...
    			add_location(path14, file$1, 61, 0, 35498);
    			...
    			add_location(path15, file$1, 62, 0, 35782);
    			...
    			add_location(path16, file$1, 63, 0, 36572);
    			...
    			add_location(path17, file$1, 64, 0, 40457);
    			...
    			add_location(path18, file$1, 65, 0, 40727);
    			...
    			add_location(path19, file$1, 66, 0, 41020);
    			...
    			add_location(path20, file$1, 67, 0, 42027);
    			...
    			add_location(path21, file$1, 68, 0, 43079);
    			...
    			add_location(ellipse1, file$1, 69, 0, 45758);
    			...
    			add_location(path22, file$1, 70, 0, 45836);
    			attr_dev(g1, "id", "atrium-group");
    			add_location(g1, file$1, 54, 0, 29023);
    			attr_dev(g2, "id", "anatomicalHeart");
    			attr_dev(g2, "class", "svelte-o857c7");
    			add_location(g2, file$1, 42, 2, 656);
    			attr_dev(svg, "width", "100%");
    			attr_dev(svg, "height", "100%");
    			attr_dev(svg, "viewBox", "0 0 300 500");
    			attr_dev(svg, "fill", "none");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			add_location(svg, file$1, 41, 2, 550);
    			attr_dev(div0, "class", "pericardium svelte-o857c7");
    			add_location(div0, file$1, 40, 2, 522);
    			attr_dev(div1, "class", "background svelte-o857c7");
    			add_location(div1, file$1, 39, 0, 495);
    		},
