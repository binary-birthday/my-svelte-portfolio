    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		...
    		i: function intro(local) {
    			if (!path0_intro) {
    				add_render_callback(() => {
    					path0_intro = create_in_transition(path0, draw, {duration: 400, delay: 100, easing: quintOut});
    					path0_intro.start();
    				});
    			}
    			...
    			if (!path1_intro) {
    				add_render_callback(() => {
    					path1_intro = create_in_transition(path1, draw, {duration: 400, delay: 200, easing: quintOut});
    					path1_intro.start();
    				});
    			}
    			...
    			if (!path2_intro) {
    				add_render_callback(() => {
    					path2_intro = create_in_transition(path2, draw, {duration: 400, delay: 300, easing: quintOut});
    					path2_intro.start();
    				});
    			}
    			...
    			if (!path3_intro) {
    				add_render_callback(() => {
    					path3_intro = create_in_transition(path3, draw, {duration: 400, delay: 400, easing: quintOut});
    					path3_intro.start();
    				});
    			}
    			...
    			if (!path4_intro) {
    				add_render_callback(() => {
    					path4_intro = create_in_transition(path4, draw, {duration: 400, delay: 500, easing: quintOut});
    					path4_intro.start();
    				});
    			}
    			...
    			if (!path5_intro) {
    				add_render_callback(() => {
    					path5_intro = create_in_transition(path5, draw, {duration: 400, delay: 600, easing: quintOut});
    					path5_intro.start();
    				});
    			}
    			...
    			if (!path6_intro) {
    				add_render_callback(() => {
    					path6_intro = create_in_transition(path6, draw, {duration: 400, delay: 700, easing: quintOut});
    					path6_intro.start();
    				});
    			}
    			...
    			if (!path7_intro) {
    				add_render_callback(() => {
    					path7_intro = create_in_transition(path7, draw, {duration: 400, delay: 800, easing: quintOut});
    					path7_intro.start();
    				});
    			}
    			...
    			if (!path8_intro) {
    				add_render_callback(() => {
    					path8_intro = create_in_transition(path8, draw, {duration: 400, delay: 900, easing: quintOut});
    					path8_intro.start();
    				});
    			}
    			...
    			if (!path9_intro) {
    				add_render_callback(() => {
    					path9_intro = create_in_transition(path9, draw, {duration: 400, delay: 1000, easing: quintOut});
    					path9_intro.start();
    				});
    			}
    			...
    			if (!path10_intro) {
    				add_render_callback(() => {
    					path10_intro = create_in_transition(path10, draw, {duration: 400, delay: 1100, easing: quintOut});
    					path10_intro.start();
    				});
    			}
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_if_block.name, type: "if", source: "(32:2) {#if visible}", ctx });
    	return block;
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path0, file$1, 50, 6, 810);
    			...
    			add_location(path1, file$1, 51, 0, 1151);
    			...
    			add_location(path2, file$1, 52, 0, 1453);
    			...
    			add_location(path3, file$1, 53, 0, 1757);
    			...
    			add_location(path4, file$1, 54, 0, 2067);
    			...
    			add_location(path5, file$1, 55, 0, 2240);
    			...
    			add_location(path6, file$1, 56, 0, 3254);
    			...
    			add_location(path7, file$1, 57, 0, 3798);
    			...
    			add_location(path8, file$1, 58, 0, 18430);
    			attr_dev(g0, "id", "ventricle-group");
    			add_location(g0, file$1, 49, 4, 779);
    			...
    			add_location(path9, file$1, 61, 0, 29139);
    			...
    			add_location(ellipse0, file$1, 62, 0, 29307);
    			...
    			add_location(path10, file$1, 63, 0, 29434);
    			...
    			add_location(path11, file$1, 64, 0, 30303);
    			...
    			add_location(path12, file$1, 65, 0, 30481);
    			...
    			add_location(path13, file$1, 66, 0, 34537);
    			...
    			add_location(path14, file$1, 67, 0, 35592);
    			...
    			add_location(path15, file$1, 68, 0, 35876);
    			...
    			add_location(path16, file$1, 69, 0, 36666);
    			...
    			add_location(path17, file$1, 70, 0, 40551);
    			...
    			add_location(path18, file$1, 71, 0, 40821);
    			...
    			add_location(path19, file$1, 72, 0, 41114);
    			...
    			add_location(path20, file$1, 73, 0, 42121);
    			...
    			add_location(path21, file$1, 74, 0, 43173);
    			...
    			add_location(ellipse1, file$1, 75, 0, 45852);
    			...
    			add_location(path22, file$1, 76, 0, 45930);
    			attr_dev(g1, "id", "atrium-group");
    			add_location(g1, file$1, 60, 0, 29117);
    			attr_dev(g2, "id", "anatomicalHeart");
    			attr_dev(g2, "class", "svelte-1r33swu");
    			add_location(g2, file$1, 48, 2, 750);
    			attr_dev(svg, "width", "100%");
    			attr_dev(svg, "height", "100%");
    			attr_dev(svg, "viewBox", "0 0 300 500");
    			attr_dev(svg, "fill", "none");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			add_location(svg, file$1, 47, 2, 644);
    			attr_dev(div0, "class", "pericardium svelte-1r33swu");
    			add_location(div0, file$1, 46, 2, 616);
    			attr_dev(div1, "class", "background svelte-1r33swu");
    			add_location(div1, file$1, 45, 0, 589);
    		},
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		...
    		i: function intro(local) {
    			if (!p0_intro) {
    				add_render_callback(() => {
    					p0_intro = create_in_transition(p0, ctx.typewriter, {delay: 1200, speed: 50});
    					p0_intro.start();
    				});
    			}
    			...
    			if (!p1_intro) {
    				add_render_callback(() => {
    					p1_intro = create_in_transition(p1, ctx.typewriter, {delay: 2000, speed: 50});
    					p1_intro.start();
    				});
    			}
    			...
    			if (!p2_intro) {
    				add_render_callback(() => {
    					p2_intro = create_in_transition(p2, ctx.typewriter, {delay: 3000, speed: 50});
    					p2_intro.start();
    				});
    			}
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_if_block$1.name, type: "if", source: "(80:4) {#if visible}", ctx });
    	return block;
    }
