...
var app = (function () {
  ...
  */
  ...
  function create_fragment$1(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(path0, file$1, 57, 6, 964);
        ...
        add_location(path1, file$1, 58, 0, 1305);
        ...
        add_location(path2, file$1, 59, 0, 1607);
        ...
        add_location(path3, file$1, 60, 0, 1911);
        ...
        add_location(path4, file$1, 61, 0, 2221);
        ...
        add_location(path5, file$1, 62, 0, 2394);
        ...
        add_location(path6, file$1, 63, 0, 3408);
        ...
        add_location(path7, file$1, 64, 0, 3952);
        ...
        add_location(path8, file$1, 65, 0, 18584);
        attr_dev(g0, "id", "ventricle-group");
        add_location(g0, file$1, 56, 4, 933);
        ...
        add_location(path9, file$1, 68, 0, 29293);
        ...
        add_location(ellipse0, file$1, 69, 0, 29461);
        ...
        add_location(path10, file$1, 70, 0, 29588);
        ...
        add_location(path11, file$1, 71, 0, 30457);
        ...
        add_location(path12, file$1, 72, 0, 30635);
        ...
        add_location(path13, file$1, 73, 0, 34691);
        ...
        add_location(path14, file$1, 74, 0, 35746);
        ...
        add_location(path15, file$1, 75, 0, 36030);
        ...
        add_location(path16, file$1, 76, 0, 36820);
        ...
        add_location(path17, file$1, 77, 0, 40705);
        ...
        add_location(path18, file$1, 78, 0, 40975);
        ...
        add_location(path19, file$1, 79, 0, 41268);
        ...
        add_location(path20, file$1, 80, 0, 42275);
        ...
        add_location(path21, file$1, 81, 0, 43327);
        ...
        add_location(ellipse1, file$1, 82, 0, 46006);
        ...
        add_location(path22, file$1, 83, 0, 46084);
        attr_dev(g1, "id", "atrium-group");
        add_location(g1, file$1, 67, 0, 29271);
        attr_dev(g2, "id", "anatomicalHeart");
        attr_dev(g2, "class", "svelte-1m7ufnc");
        add_location(g2, file$1, 55, 2, 904);
        attr_dev(svg, "width", "95%");
        attr_dev(svg, "height", "95%");
        attr_dev(svg, "viewBox", "0 0 300 500");
        attr_dev(svg, "fill", "none");
        attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
        add_location(svg, file$1, 54, 2, 800);
        attr_dev(div0, "class", "pericardium svelte-1m7ufnc");
        add_location(div0, file$1, 53, 2, 772);
        attr_dev(div1, "class", "background svelte-1m7ufnc");
        add_location(div1, file$1, 52, 0, 745);
      },
      l: function claim(nodes) {
        throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
      },
  ...
  var file$2 = "src/Greeting.svelte"; // (69:4) {#if visible}
  ...
  function create_if_block$1(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        attr_dev(p0, "class", "greting1 svelte-1vb53z8");
        add_location(p0, file$2, 69, 4, 1233);
        attr_dev(p1, "class", "greting2 svelte-1vb53z8");
        add_location(p1, file$2, 70, 3, 1310);
        attr_dev(p2, "class", "greting3 svelte-1vb53z8");
        add_location(p2, file$2, 71, 3, 1396);
      },
      m: function mount(target, anchor) {
  ...
  function create_fragment$2(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        attr_dev(div0, "class", "right svelte-1vb53z8");
        add_location(div0, file$2, 67, 2, 1190);
        attr_dev(div1, "class", "landing-container svelte-1vb53z8");
        add_location(div1, file$2, 66, 0, 1156);
      },
      l: function claim(nodes) {
  ...
  var file$3 = "src/AboutMe.svelte"; // (106:4) {#if scrollPos > 100}

  function create_if_block$2(ctx) {
    var div0, img0, img0_intro, t0, div4, div3, div1, img1, t1, p, t2, a0, t4, a1, t6, a2, t8, a3, t10, t11, div2, a4, i0, t12, a5, i1, t13, a6, i2, t14, a7, i3, div3_transition, current;
    var block = {
      c: function create() {
        div0 = element("div");
        img0 = element("img");
        ...
        a7 = element("a");
        i3 = element("i");
        attr_dev(img0, "class", "about svelte-1k1jyt1");
        attr_dev(img0, "src", "images/ABOUT.svg");
        attr_dev(img0, "alt", "about");
        add_location(img0, file$3, 107, 6, 1841);
        attr_dev(div0, "class", "about-container svelte-1k1jyt1");
        add_location(div0, file$3, 106, 4, 1805);
        attr_dev(img1, "class", "profile svelte-1k1jyt1");
        attr_dev(img1, "src", "images/profile.jpg");
        attr_dev(img1, "alt", "profile image");
        add_location(img1, file$3, 112, 10, 2156);
        attr_dev(a0, "href", "https://github.com/Wade-Martin/rails_marketplace_app");
        attr_dev(a0, "target", "_blank");
        add_location(a0, file$3, 114, 571, 2811);
        attr_dev(a1, "href", "https://github.com/Wade-Martin/MERN-App-Front-End");
        attr_dev(a1, "target", "_blank");
        add_location(a1, file$3, 114, 820, 3060);
        attr_dev(a2, "href", "https://github.com/Wade-Martin/MERN-App-Back-End");
        attr_dev(a2, "target", "_blank");
        add_location(a2, file$3, 114, 928, 3168);
        attr_dev(a3, "href", "https://web3-build.netlify.com/");
        attr_dev(a3, "target", "_blank");
        add_location(a3, file$3, 114, 1178, 3418);
        attr_dev(p, "class", "svelte-1k1jyt1");
        add_location(p, file$3, 113, 10, 2235);
        add_location(div1, file$3, 111, 8, 2140);
        attr_dev(i0, "class", "fab fa-github svelte-1k1jyt1");
        add_location(i0, file$3, 118, 70, 3614);
        attr_dev(a4, "href", "https://github.com/Wade-Martin");
        attr_dev(a4, "target", "_blank");
        add_location(a4, file$3, 118, 10, 3554);
        attr_dev(i1, "class", "fab fa-codepen svelte-1k1jyt1");
        add_location(i1, file$3, 119, 67, 3719);
        attr_dev(a5, "href", "https://codepen.io/wade-martin");
        attr_dev(a5, "target", "_blank");
        add_location(a5, file$3, 119, 10, 3662);
        attr_dev(i2, "class", "fab fa-linkedin svelte-1k1jyt1");
        add_location(i2, file$3, 120, 79, 3836);
        attr_dev(a6, "href", "https://www.linkedin.com/in/wade-s-martin/");
        attr_dev(a6, "target", "_blank");
        add_location(a6, file$3, 120, 10, 3767);
        attr_dev(i3, "class", "fab fa-twitter-square svelte-1k1jyt1");
        add_location(i3, file$3, 121, 74, 3950);
        attr_dev(a7, "href", "https://twitter.com/wine_and_Wade");
        attr_dev(a7, "target", "_blank");
        add_location(a7, file$3, 121, 10, 3886);
        attr_dev(div2, "class", "icons svelte-1k1jyt1");
        add_location(div2, file$3, 117, 8, 3524);
        attr_dev(div3, "class", "card svelte-1k1jyt1");
        add_location(div3, file$3, 110, 6, 2025);
        attr_dev(div4, "class", "card-container svelte-1k1jyt1");
        add_location(div4, file$3, 109, 4, 1990);
      },
      m: function mount(target, anchor) {
      ...
      i: function intro(local) {
        ...
        if (!img0_intro) {
          add_render_callback(function () {
            img0_intro = create_in_transition(img0, fly, {
              delay: 0,
              duration: 2000,
              y: -300,
              opacity: .01,
  ...
  function create_fragment$3(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        div0 = element("div");
        if (if_block) if_block.c();
        attr_dev(div0, "class", "wrapper svelte-1k1jyt1");
        add_location(div0, file$3, 104, 2, 1752);
        attr_dev(div1, "class", "container svelte-1k1jyt1");
        attr_dev(div1, "loaded", ctx.loaded);
        add_location(div1, file$3, 102, 0, 1707);
      },
      l: function claim(nodes) {
        throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
      },
  ...
  function create_if_block$3(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(input2, file$4, 129, 6, 3098);
        ...
        add_location(textarea, file$4, 130, 6, 3270);
        attr_dev(input3, "type", "submit");
        input3.value = "SUBMIT";
        attr_dev(input3, "class", "svelte-9b146h");
        add_location(input3, file$4, 131, 6, 3456);
  ...
  function create_fragment$5(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(div, file$5, 53, 0, 1020);
  ...
  function instance$5($$self, $$props, $$invalidate) {
    ...
    var getPostion = function getPostion() {
      var newPostion = document.getElementById('main').getBoundingClientRect().top;
      return newPostion;
    };
