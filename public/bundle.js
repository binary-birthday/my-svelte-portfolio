...
var app = (function () {
  ...
  */
  ...
  var file = "src/NavBar.svelte"; // (32:0) {#if scrollPos > 200}

  function create_if_block(ctx) {
    var div, svg, path0, path0_intro, path1, path1_intro, path2, path2_intro, path3, path3_intro, path4, path4_intro, path5, path5_intro, path6, path6_intro, path7, path7_intro, path8, path8_intro, path9, path9_intro, path10, path10_intro, div_intro;
    var block = {
      c: function create() {
        div = element("div");
        svg = svg_element("svg");
        ...
        add_location(path2, file, 36, 4, 1040);
        ...
        add_location(path3, file, 37, 4, 1238);
        ...
        add_location(path4, file, 38, 4, 1413);
        ...
        add_location(path10, file, 44, 4, 2481);
        attr_dev(svg, "class", "myName svelte-1gtu1yv");
        attr_dev(svg, "viewBox", "0 0 1017 163");
        attr_dev(svg, "stroke", "#0E79B2");
        attr_dev(svg, "fill", "none");
        attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
        add_location(svg, file, 33, 2, 626);
        attr_dev(div, "class", "navbar svelte-1gtu1yv");
        add_location(div, file, 32, 0, 544);
      },
  ...
  function create_fragment(ctx) {
    var if_block_anchor;
    var if_block = ctx.scrollPos > 200 && create_if_block(ctx);
    var block = {
      c: function create() {
  ...
  function instance($$self, $$props, $$invalidate) {
    ...
    Object.keys($$props).forEach(function (key) {
      if (!writable_props.includes(key) && !key.startsWith('$$')) console.warn("<NavBar> was created with unknown prop '".concat(key, "'"));
    });
  ...
  function (_SvelteComponentDev) {
    ...
    function NavBar(options) {
      ...
      init(_assertThisInitialized(_this), options, instance, create_fragment, safe_not_equal, ["scrollPos"]);
  ...
  function create_fragment$1(ctx) {
    var div1, div0, svg, g2, g0, path0, path1, path2, path3, path4, path5, path6, path7, path8, g1, path9, ellipse0, path10, path11, path12, path13, path14, path15, path16, path17, path18, path19, path20, path21, ellipse1, path22, g2_transition, current;
    var block = {
      c: function create() {
        div1 = element("div");
        div0 = element("div");
        ...
        add_location(path0, file$1, 66, 6, 1148);
        ...
        add_location(path1, file$1, 67, 0, 1489);
        ...
        add_location(path2, file$1, 68, 0, 1791);
        ...
        add_location(path3, file$1, 69, 0, 2095);
        ...
        add_location(path4, file$1, 70, 0, 2405);
        ...
        add_location(path5, file$1, 71, 0, 2578);
        ...
        add_location(path6, file$1, 72, 0, 3592);
        ...
        add_location(path7, file$1, 73, 0, 4136);
        ...
        add_location(path8, file$1, 74, 0, 18768);
        attr_dev(g0, "id", "ventricle-group");
        add_location(g0, file$1, 65, 4, 1117);
        ...
        add_location(path9, file$1, 77, 0, 29477);
        ...
        add_location(ellipse0, file$1, 78, 0, 29645);
        ...
        add_location(path10, file$1, 79, 0, 29772);
        ...
        add_location(path11, file$1, 80, 0, 30641);
        ...
        add_location(path12, file$1, 81, 0, 30819);
        ...
        add_location(path13, file$1, 82, 0, 34875);
        ...
        add_location(path14, file$1, 83, 0, 35930);
        ...
        add_location(path15, file$1, 84, 0, 36214);
        ...
        add_location(path16, file$1, 85, 0, 37004);
        ...
        add_location(path17, file$1, 86, 0, 40889);
        ...
        add_location(path18, file$1, 87, 0, 41159);
        ...
        add_location(path19, file$1, 88, 0, 41452);
        ...
        add_location(path20, file$1, 89, 0, 42459);
        ...
        add_location(path21, file$1, 90, 0, 43511);
        ...
        add_location(ellipse1, file$1, 91, 0, 46190);
        ...
        add_location(path22, file$1, 92, 0, 46268);
        attr_dev(g1, "id", "atrium-group");
        add_location(g1, file$1, 76, 0, 29455);
        attr_dev(g2, "id", "anatomicalHeart");
        attr_dev(g2, "class", "svelte-8wl1ud");
        add_location(g2, file$1, 64, 2, 1041);
        attr_dev(svg, "viewBox", "0 0 300 500");
        attr_dev(svg, "fill", "none");
        attr_dev(svg, "preserveAspectRatio", "xMaxYMax");
        attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
        attr_dev(svg, "class", "svelte-8wl1ud");
        add_location(svg, file$1, 63, 2, 933);
        attr_dev(div0, "class", "pericardium svelte-8wl1ud");
        add_location(div0, file$1, 62, 2, 905);
        attr_dev(div1, "class", "background svelte-8wl1ud");
        add_location(div1, file$1, 61, 0, 878);
      },
      l: function claim(nodes) {
        throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
      },
      ...
      i: function intro(local) {
        if (current) return;
        add_render_callback(function () {
          if (!g2_transition) g2_transition = create_bidirectional_transition(g2, fade, {
            delay: 0,
            duration: 4000
          }, true);
          g2_transition.run(1);
      ...
      d: function destroy(detaching) {
        if (detaching) {
          detach_dev(div1);
          if (g2_transition) g2_transition.end();
        }
      }
    };
    dispatch_dev("SvelteRegisterBlock", {
  ...
  var file$2 = "src/Greeting.svelte"; // (101:2) {#if visible}

  function create_if_block$1(ctx) {
    var div, span0, span0_intro, t1, span1, span1_intro, br0, t3, span2, span2_intro, br1, t5, span3, span3_intro, br2, t7, span4, span4_intro, div_outro, t9, current;
    ...
    var block = {
      c: function create() {
        ...
        t5 = space();
        span3 = element("span");
        span3.textContent = "I build webapps.";
        br2 = element("br");
        t7 = space();
        span4 = element("span");
        ...
        attr_dev(span0, "class", "svelte-1qwcz0");
        add_location(span0, file$2, 102, 4, 1818);
        attr_dev(span1, "class", "svelte-1qwcz0");
        add_location(span1, file$2, 103, 4, 1890);
        add_location(br0, file$2, 103, 71, 1957);
        attr_dev(span2, "class", "strong svelte-1qwcz0");
        add_location(span2, file$2, 104, 3, 1965);
        add_location(br1, file$2, 104, 86, 2048);
        attr_dev(span3, "class", "svelte-1qwcz0");
        add_location(span3, file$2, 105, 3, 2056);
        add_location(br2, file$2, 105, 76, 2129);
        attr_dev(span4, "class", "svelte-1qwcz0");
        add_location(span4, file$2, 106, 3, 2137);
        attr_dev(div, "class", "left svelte-1qwcz0");
        add_location(div, file$2, 101, 2, 1754);
      },
      m: function mount(target, anchor) {
        insert_dev(target, div, anchor);
        ...
        mount_component(beatingheart, target, anchor);
        current = true;
      },
      i: function intro(local) {
        if (current) return;
      ...
      d: function destroy(detaching) {
        ...
        destroy_component(beatingheart, detaching);
      }
    };
    dispatch_dev("SvelteRegisterBlock", {
      block: block,
  ...
  function create_fragment$2(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        attr_dev(div, "class", "landing-container svelte-1qwcz0");
        add_location(div, file$2, 99, 0, 1676);
      },
      l: function claim(nodes) {
  ...
  function instance$2($$self, $$props, $$invalidate) {
    ...
    var writable_props = ['scrollPos'];
    Object.keys($$props).forEach(function (key) {
      if (!writable_props.includes(key) && !key.startsWith('$$')) console.warn("<Greeting> was created with unknown prop '".concat(key, "'"));
    });
    ...
    $$self.$$.update = function () {
      ...
      if ($$dirty.scrollPos || $$dirty.height) {
    ...
    return {
      ...
      height: height,
      visible: visible,
      div_resize_handler: div_resize_handler
    };
  }
  ...
  function (_SvelteComponentDev) {
    ...
    function Greeting(options) {
      ...
      init(_assertThisInitialized(_this), options, instance$2, create_fragment$2, safe_not_equal, ["scrollPos"]);
      dispatch_dev("SvelteRegisterComponent", {
        component: _assertThisInitialized(_this),
        tagName: "Greeting",
        options: options,
  ...
  var file$3 = "src/AboutMe.svelte"; // (115:4) {#if scrollPos > 100}

  function create_if_block$2(ctx) {
    var div0, img0, img0_intro, img0_outro, t0, div3, div2, img1, t1, p, t3, div1, a0, i0, t4, a1, i1, t5, a2, i2, t6, a3, i3, div3_intro, div3_outro, current;
    var block = {
      c: function create() {
        div0 = element("div");
        img0 = element("img");
        ...
        a3 = element("a");
        i3 = element("i");
        attr_dev(img0, "class", "about svelte-1ortdg6");
        attr_dev(img0, "src", "images/ABOUT.svg");
        attr_dev(img0, "alt", "about");
        add_location(img0, file$3, 116, 6, 2034);
        attr_dev(div0, "class", "about-container svelte-1ortdg6");
        add_location(div0, file$3, 115, 4, 1998);
        attr_dev(img1, "class", "profile svelte-1ortdg6");
        attr_dev(img1, "src", "images/profile.jpg");
        attr_dev(img1, "alt", "profile image");
        add_location(img1, file$3, 120, 8, 2409);
        attr_dev(p, "class", "svelte-1ortdg6");
        add_location(p, file$3, 121, 8, 2486);
        attr_dev(i0, "class", "fab fa-github svelte-1ortdg6");
        add_location(i0, file$3, 125, 70, 3224);
        attr_dev(a0, "href", "https://github.com/Wade-Martin");
        attr_dev(a0, "target", "_blank");
        add_location(a0, file$3, 125, 10, 3164);
        attr_dev(i1, "class", "fab fa-codepen svelte-1ortdg6");
        add_location(i1, file$3, 126, 67, 3329);
        attr_dev(a1, "href", "https://codepen.io/wade-martin");
        attr_dev(a1, "target", "_blank");
        add_location(a1, file$3, 126, 10, 3272);
        attr_dev(i2, "class", "fab fa-linkedin svelte-1ortdg6");
        add_location(i2, file$3, 127, 79, 3446);
        attr_dev(a2, "href", "https://www.linkedin.com/in/wade-s-martin/");
        attr_dev(a2, "target", "_blank");
        add_location(a2, file$3, 127, 10, 3377);
        attr_dev(i3, "class", "fab fa-twitter-square svelte-1ortdg6");
        add_location(i3, file$3, 128, 74, 3560);
        attr_dev(a3, "href", "https://twitter.com/wine_and_Wade");
        attr_dev(a3, "target", "_blank");
        add_location(a3, file$3, 128, 10, 3496);
        attr_dev(div1, "class", "icons svelte-1ortdg6");
        add_location(div1, file$3, 124, 8, 3134);
        attr_dev(div2, "class", "card svelte-1ortdg6");
        add_location(div2, file$3, 119, 6, 2382);
        attr_dev(div3, "class", "card-container svelte-1ortdg6");
        add_location(div3, file$3, 118, 4, 2227);
      },
      m: function mount(target, anchor) {
      ...
      i: function intro(local) {
        if (current) return;
        add_render_callback(function () {
          if (img0_outro) img0_outro.end(1);
          if (!img0_intro) img0_intro = create_in_transition(img0, fly, {
            delay: 800,
            duration: 3000,
            y: -400,
            opacity: .01,
      ...
      o: function outro(local) {
        if (img0_intro) img0_intro.invalidate();
        img0_outro = create_out_transition(img0, fade, {
          delay: 250,
          duration: 2000
        });
  ...
  function create_fragment$3(ctx) {
    var div1, div0, div1_resize_listener, current;
    var if_block = ctx.scrollPos > 100 && create_if_block$2(ctx);
    var block = {
      c: function create() {
        div1 = element("div");
        div0 = element("div");
        if (if_block) if_block.c();
        attr_dev(div0, "class", "wrapper svelte-1ortdg6");
        add_location(div0, file$3, 113, 2, 1945);
        add_render_callback(function () {
          return ctx.div1_resize_handler.call(div1);
        });
        attr_dev(div1, "class", "container svelte-1ortdg6");
        add_location(div1, file$3, 112, 0, 1891);
      },
      l: function claim(nodes) {
        throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
      },
  ...
  function instance$3($$self, $$props, $$invalidate) {
    var scrollPos = $$props.scrollPos,
        height = $$props.height;
    var writable_props = ['scrollPos', 'height'];
    Object.keys($$props).forEach(function (key) {
    ...
    return {
      scrollPos: scrollPos,
      height: height,
      div1_resize_handler: div1_resize_handler
    };
  }
  ...
  function (_SvelteComponentDev) {
    ...
    function AboutMe(options) {
      ...
      init(_assertThisInitialized(_this), options, instance$3, create_fragment$3, safe_not_equal, ["scrollPos", "height"]);
      dispatch_dev("SvelteRegisterComponent", {
        component: _assertThisInitialized(_this),
        tagName: "AboutMe",
        options: options,
      ...
      if (ctx.scrollPos === undefined && !('scrollPos' in props)) {
        console.warn("<AboutMe> was created without expected prop 'scrollPos'");
      }

      if (ctx.height === undefined && !('height' in props)) {
        console.warn("<AboutMe> was created without expected prop 'height'");
      }
  ...
  var file$4 = "src/Contact.svelte"; // (132:4) {#if (scrollPos + (windowHeight * .5)) > elementPos }
  ...
  function create_if_block_1(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(input0, file$4, 134, 54, 2923);
        add_location(label, file$4, 134, 10, 2879);
        attr_dev(p, "class", "dn svelte-53kj8n");
        add_location(p, file$4, 133, 8, 2854);
        attr_dev(input1, "name", "name");
        attr_dev(input1, "type", "text");
        attr_dev(input1, "class", "form-input svelte-53kj8n");
        attr_dev(input1, "placeholder", "Your Name");
        add_location(input1, file$4, 136, 8, 2979);
        attr_dev(input2, "name", "email");
        attr_dev(input2, "type", "text");
        attr_dev(input2, "class", "form-input svelte-53kj8n");
        attr_dev(input2, "placeholder", "Your Email");
        add_location(input2, file$4, 137, 8, 3156);
        attr_dev(textarea, "name", "text");
        attr_dev(textarea, "class", "form-input svelte-53kj8n");
        attr_dev(textarea, "placeholder", "Your Message here...");
        add_location(textarea, file$4, 138, 8, 3333);
        attr_dev(input3, "type", "submit");
        input3.value = "SUBMIT";
        attr_dev(input3, "class", "svelte-53kj8n");
        add_location(input3, file$4, 139, 8, 3520);
        attr_dev(form, "action", "https://formspree.io/wsmartin23@gmail.com");
        attr_dev(form, "method", "POST");
        attr_dev(form, "class", "svelte-53kj8n");
        add_location(form, file$4, 132, 6, 2768);
      },
      m: function mount(target, anchor) {
      ...
      d: function destroy(detaching) {
        if (detaching) {
          detach_dev(form);
          if (input1_transition) input1_transition.end();
          if (input2_transition) input2_transition.end();
          if (textarea_transition) textarea_transition.end();
          if (input3_transition) input3_transition.end();
        }
      }
    };
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "if",
      source: "(132:4) {#if (scrollPos + (windowHeight * .5)) > elementPos }",
      ctx: ctx
    });
    return block;
  } // (144:4) {#if (scrollPos + (windowHeight * .5)) > elementPos }


  function create_if_block$3(ctx) {
    var div, svg, path0, path0_intro, path1, path1_intro, path2, path2_intro, path3, path3_intro, path4, path4_intro, path5, path5_intro, path6, path6_intro, path7, path7_intro, path8, path8_intro, svg_outro, current;
    var block = {
      c: function create() {
        div = element("div");
        svg = svg_element("svg");
        ...
        attr_dev(path0, "stroke-width", "4");
        add_location(path0, file$4, 146, 6, 3936);
        attr_dev(path1, "d", "M162 5V75L82 75M82 75H2L2 5L82 75ZM82 75V5");
        attr_dev(path1, "stroke-width", "4");
        add_location(path1, file$4, 147, 6, 4080);
        ...
        attr_dev(path2, "stroke-width", "4");
        add_location(path2, file$4, 148, 6, 4218);
        ...
        attr_dev(path3, "stroke-width", "4");
        add_location(path3, file$4, 149, 6, 4524);
        ...
        attr_dev(path4, "stroke-width", "4");
        add_location(path4, file$4, 150, 6, 4771);
        attr_dev(path5, "d", "M162 590L2 660H162V590ZM162 590H2");
        attr_dev(path5, "stroke-width", "4");
        add_location(path5, file$4, 151, 6, 5018);
        attr_dev(path6, "d", "M162 534H2M2 534L2 569M2 534L2 499");
        attr_dev(path6, "stroke-width", "4");
        add_location(path6, file$4, 152, 6, 5147);
        attr_dev(path7, "d", "M162 282H2M2 282L2 317M2 282L2 247");
        attr_dev(path7, "stroke-width", "4");
        add_location(path7, file$4, 153, 6, 5277);
        attr_dev(path8, "d", "M162 499L2 465.75L162 429V499Z");
        attr_dev(path8, "stroke-width", "4");
        add_location(path8, file$4, 154, 6, 5407);
        attr_dev(svg, "class", "contact svelte-53kj8n");
        attr_dev(svg, "viewBox", "0 0 164 844");
        attr_dev(svg, "fill", "none");
        attr_dev(svg, "stroke", "#E01E41");
        attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
        add_location(svg, file$4, 145, 4, 3783);
        attr_dev(div, "class", "svg-container svelte-53kj8n");
        add_location(div, file$4, 144, 4, 3751);
      },
      m: function mount(target, anchor) {
        insert_dev(target, div, anchor);
        append_dev(div, svg);
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "if",
      source: "(144:4) {#if (scrollPos + (windowHeight * .5)) > elementPos }",
      ctx: ctx
    });
    return block;
  }
  ...
  function create_fragment$4(ctx) {
    var div2, svg, path0, path1, path2, t0, div1, div0, t1, current;
    var if_block0 = ctx.scrollPos + ctx.windowHeight * .5 > ctx.elementPos && create_if_block_1(ctx);
    var if_block1 = ctx.scrollPos + ctx.windowHeight * .5 > ctx.elementPos && create_if_block$3(ctx);
    var block = {
      c: function create() {
        div2 = element("div");
        svg = svg_element("svg");
        ...
        add_location(path0, file$4, 125, 3, 2312);
        attr_dev(path1, "d", "M1920 1066.7V1079.99L421.496 1079.99L309.761 631.773L1920 1066.7Z");
        attr_dev(path1, "fill", "#1D1D1D");
        add_location(path1, file$4, 126, 3, 2440);
        attr_dev(path2, "d", "M317.44 633.103L709.12 1080H-0.000427246V718.295L317.44 633.103Z");
        attr_dev(path2, "fill", "#313131");
        add_location(path2, file$4, 127, 3, 2536);
        attr_dev(svg, "class", "background svelte-53kj8n");
        attr_dev(svg, "viewBox", "0 0 1920 1080");
        attr_dev(svg, "preserveAspectRatio", "none");
        attr_dev(svg, "fill", "none");
        attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
        add_location(svg, file$4, 124, 2, 2186);
        attr_dev(div0, "id", "form");
        attr_dev(div0, "class", "form-container svelte-53kj8n");
        add_location(div0, file$4, 130, 4, 2665);
        attr_dev(div1, "class", "wrapper svelte-53kj8n");
        add_location(div1, file$4, 129, 2, 2639);
        attr_dev(div2, "class", "main svelte-53kj8n");
        attr_dev(div2, "windowheight", ctx.windowHeight);
        attr_dev(div2, "scrollpos", ctx.scrollPos);
        attr_dev(div2, "elementpos", ctx.elementPos);
        add_location(div2, file$4, 123, 0, 2125);
      },
      l: function claim(nodes) {
        throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
      },
      ...
      p: function update(changed, ctx) {
        if (ctx.scrollPos + ctx.windowHeight * .5 > ctx.elementPos) {
          if (!if_block0) {
  ...
  function create_fragment$5(ctx) {
    ...
    function aboutme_height_binding(value) {
      ctx.aboutme_height_binding.call(null, value);
      updating_height = true;
      add_flush_callback(function () {
        return updating_height = false;
      });
    }
    ...
    if (ctx.height !== void 0) {
      aboutme_props.height = ctx.height;
    }
    ...
    binding_callbacks.push(function () {
      return bind$1(aboutme, 'height', aboutme_height_binding);
    });
    ...
    var block = {
      c: function create() {
        ...
        t2 = space();
        contact.$$.fragment.c();
        attr_dev(div, "class", "svelte-cf5612");
        add_location(div, file$5, 48, 0, 1047);
      ...
      p: function update(changed, ctx) {
        ...
        var navbar_changes = {};
        if (changed.scrollPos) navbar_changes.scrollPos = ctx.scrollPos;
        navbar.$set(navbar_changes);
        var greeting_changes = {};
        if (changed.scrollPos) greeting_changes.scrollPos = ctx.scrollPos;
        greeting.$set(greeting_changes);
        var aboutme_changes = {};
        if (changed.scrollPos) aboutme_changes.scrollPos = ctx.scrollPos;

        if (!updating_height && changed.height) {
          aboutme_changes.height = ctx.height;
        }
  ...
  function instance$5($$self, $$props, $$invalidate) {
    ...
    var handleResize = function handleResize() {
      setVhVar();
      $$invalidate('elementPos', elementPos = getPostion());
    };
    ...
    function onwindowresize() {
      ...
      $$invalidate('windowHeight', windowHeight);
    }
    ...
    $$self.$inject_state = function ($$props) {
      ...
      if ('windowHeight' in $$props) $$invalidate('windowHeight', windowHeight = $$props.windowHeight);
      if ('height' in $$props) $$invalidate('height', height = $$props.height);
      if ('initHeight' in $$props) $$invalidate('initHeight', initHeight = $$props.initHeight);
    };
    ...
    $$self.$$.update = function () {
      ...
      if ($$dirty.initHeight || $$dirty.height) {
    ...
    return {
      ...
      aboutme_height_binding: aboutme_height_binding
    };
  }
